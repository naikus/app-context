  ...
  const rootContext = {
    register(moduleDefn) {
      ...
      if(started) {
        ...
        // to do the initialization to provide correct dependency. Using "this" will cause the modules
        // to use their module-specific contexts to initialize which will result in incorrect circular
        // dependencies
    ...
    async start() {
      ...
      for(const modInfo of modInfos) {
        ...
        initPromise.then(() => initializeModule(rootContext, modInfo));
